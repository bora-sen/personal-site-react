...
function Header() {
  return (
    <section className='sticky flex-col sm:flex-row gap-4 sm:gap-0 top-0 z-10 font-poppins flex justify-between items-center px-3 py-2 h-auto mb-4 shadow-xl backdrop-blur-md bg-primary bg-opacity-10'>
